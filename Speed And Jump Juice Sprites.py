...
image = simplegui.load_image('https://i.imgur.com/t3bF3Wg.png')  # speedJuice

# jumpJuice
# https://i.imgur.com/XmUEFOg.png
...
timer = simplegui.create_timer(50, nextFrame)
timer.start()
frame = simplegui.create_frame('Testing', 70, 70)
